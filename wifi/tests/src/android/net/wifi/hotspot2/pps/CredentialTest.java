...
public class CredentialTest {
    ...
    private static Credential createCredentialWithUserCredentialAndExpandedEAP() {
        ...
        userCred.eapVendorId = 1;
        userCred.eapVendorType = 2;
    ...
    private static Credential createCredentialWithUserCredentialAndInnerEAP() {
        ...
        userCred.password = "password";
        userCred.eapType = Credential.EAP_TLS;
        userCred.innerEapType = Credential.EAP_TTLS;
        userCred.innerEapVendorId = 1;
        userCred.innerEapVendorType = 2;
        return createCredential(userCred, null, null, FakeKeys.CA_CERT0,
                new X509Certificate[] {FakeKeys.CLIENT_CERT}, FakeKeys.RSA_KEY1);
    }
    ...
    private static Credential createCredentialWithUserCredentialAndNonEapInnerMethod() {
        ...
        return createCredential(userCred, null, null, null, null, null);
    }
